...
# Generated on: Wed Jan 28 12:58:39 IST 2026 (Wed Jan 28 07:28:39 UTC 2026)
...
set logfile fv/systolic_array/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/systolic_array -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  mac_unit.sv
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  systolic_array.sv
elaborate_design -golden -root {systolic_array} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/systolic_array/fv_map.v.gz
...
#add_name_alias fv/systolic_array/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.systolic_array.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.systolic_array.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.systolic_array.rtl.fv_map.rpt
